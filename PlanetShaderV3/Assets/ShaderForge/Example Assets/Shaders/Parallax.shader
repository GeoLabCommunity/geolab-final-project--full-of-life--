...
/////// Normals:
                ...
                float2 node_110 = (0.5*(tex2D(_AORGBHeightA,TRANSFORM_TEX(node_35, _AORGBHeightA)).a - 0.5)*mul(tangentTransform, viewDirection).xy + node_35);
